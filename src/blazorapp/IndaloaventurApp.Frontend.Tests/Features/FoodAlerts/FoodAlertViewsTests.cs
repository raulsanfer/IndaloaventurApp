namespace IndaloaventurApp.Frontend.Tests.Features.FoodAlerts;
...
{
    /// <summary>
    /// Covers scenario: food alerts home view renders three category cards.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: food alert category view shows empty state when category has no alerts.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: food alert category view shows alert link and summary.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: food alert detail view shows back link and normalized description.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: food alert detail view shows error state when service fails.
    /// </summary>
    [Fact]
