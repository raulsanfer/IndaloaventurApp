...
{
    /// <summary>
    /// Covers scenario: get alerts uses category endpoint and maps items.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get alert returns not found on404.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get alert maps detail payload.
    /// </summary>
    [Fact]
