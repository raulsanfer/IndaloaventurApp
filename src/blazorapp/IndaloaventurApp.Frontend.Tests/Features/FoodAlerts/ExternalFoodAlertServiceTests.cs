...
{
    /// <summary>
    /// Covers scenario: get alerts normalizes html and builds summary.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get alerts returns invalid category for unsupported code.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get alert uses detail endpoint and normalizes description.
    /// </summary>
    [Fact]
