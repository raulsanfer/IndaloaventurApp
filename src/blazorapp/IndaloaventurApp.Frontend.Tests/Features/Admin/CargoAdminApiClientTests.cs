...
{
    /// <summary>
    /// Covers scenario: get cargos uses endpoint and maps payload.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: create cargo posts payload and returns mapped cargo.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update cargo puts payload to endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: delete cargo returns conflict error on conflict.
    /// </summary>
    [Fact]
