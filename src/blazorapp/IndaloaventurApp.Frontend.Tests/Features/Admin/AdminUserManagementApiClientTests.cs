...
{
    /// <summary>
    /// Covers scenario: get users uses users endpoint and returns matching users.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get users without email uses users endpoint without query.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: create member file posts compatible payload for current backend.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update member file puts admin payload.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: deactivate user posts to deactivate endpoint.
    /// </summary>
    [Fact]
