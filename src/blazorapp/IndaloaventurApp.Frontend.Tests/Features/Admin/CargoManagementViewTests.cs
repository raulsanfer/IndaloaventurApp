...
{
    /// <summary>
    /// Covers scenario: cargo management view renders breadcrumb fieldset and list.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: cargo management view creates cargo and resets to new mode.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: cargo management view loads selected cargo into fieldset and updates it.
    /// </summary>
    [Fact]
