...
{
    /// <summary>
    /// Covers scenario: set session persists to session storage when remember me is disabled.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: ensure initialized restores valid session from local storage.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: ensure initialized removes expired persisted sessions.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: sign out removes persisted sessions from both storages.
    /// </summary>
    [Fact]
