...
{
    /// <summary>
    /// Covers scenario: login uses payload is member when JWT does not contain claim.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: login social posts provider and token and maps session.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: login social returns invalid social error on unauthorized.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: login social reads admin role from JWT claims.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: request password recovery posts email and returns neutral message.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: reset password returns backend problem detail on conflict.
    /// </summary>
    [Fact]
