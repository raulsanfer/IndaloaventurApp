...
{
    /// <summary>
    /// Covers scenario: get federative licenses uses admin endpoint and filters.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update federative license status puts expected payload.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get federative licenses returns forbidden for non admin session.
    /// </summary>
    [Fact]
