...
{
    /// <summary>
    /// Covers scenario: admin federative license management view loads with initial user filter.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: admin federative license management view updates status and reloads list.
    /// </summary>
    [Fact]
