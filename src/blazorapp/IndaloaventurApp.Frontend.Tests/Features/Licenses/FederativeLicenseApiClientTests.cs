...
{
    /// <summary>
    /// Covers scenario: get my federative licenses gets licenses from me endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get available rates uses season and modality filters.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: create federative license request posts expected payload.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get my federative licenses returns not member error for admin role.
    /// </summary>
    [Fact]
