namespace IndaloaventurApp.Frontend.Tests.Features.Licenses;
...
{
    /// <summary>
    /// Covers scenario: federative licenses view shows non operational state when session has no member access.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: federative licenses view shows non operational state for admin role.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: federative licenses view groups licenses by season and renders state.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: federative licenses view loads rates when season is selected.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: federative licenses view shows empty rates message when selected season has no rates.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: federative licenses view reloads rates when modality changes.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: federative licenses view creates request and refreshes list.
    /// </summary>
    [Fact]
