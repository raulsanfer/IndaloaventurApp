...
{
    /// <summary>
    /// Covers scenario: get signal home data does not call images endpoint and leaves image url null.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get signal images maps photos to data urls.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get signal images returns empty image urls when payload has no usable photo.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get signal uses signal detail endpoint and maps resolved category.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get signal returns not found when API returns404.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get signal comments uses comments endpoint and maps comments.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: create signal category posts to signal types endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update signal category puts to signal type detail endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: delete signal category returns blocked error on conflict.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: create signal posts title and photos to signals endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update signal puts only editable fields to signal detail endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update signal returns forbidden when API returns403.
    /// </summary>
    [Fact]
