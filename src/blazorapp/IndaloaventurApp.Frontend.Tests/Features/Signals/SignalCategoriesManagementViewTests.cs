...
{
    /// <summary>
    /// Covers scenario: signal settings hub view renders categories entry.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal categories management view renders list and empty editor.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal categories management view creates category and refreshes list.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal categories management view updates category after selecting edit.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal categories management view shows blocked delete message when backend rejects delete.
    /// </summary>
    [Fact]
