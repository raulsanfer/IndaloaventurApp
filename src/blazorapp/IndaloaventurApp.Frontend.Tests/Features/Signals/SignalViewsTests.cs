namespace IndaloaventurApp.Frontend.Tests.Features.Signals;
...
{
    /// <summary>
    /// Covers scenario: signal home view renders detail links for cards.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal home view renders resolved image when signal provides image url.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view shows location empty state when signal has no coordinates.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view preserves breadcrumb and renders overview header.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view renders available images without blocking detail.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view shows single image when only one photo is available.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view shows image error without blocking detail.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view shows map when signal has coordinates.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view renders comments below tabs and tags at end.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view shows edit button for signal owner.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view saves own signal edit.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal detail view keeps draft when save fails.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal create view renders separate camera and gallery inputs per photo slot.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal create view uses distinct interop targets for camera and gallery buttons.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal create view allows moving to review with only photo1.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal create view removes photo2 from review without affecting photo1.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: signal create view sends empty photo2 when saving with only photo1.
    /// </summary>
    [Fact]
