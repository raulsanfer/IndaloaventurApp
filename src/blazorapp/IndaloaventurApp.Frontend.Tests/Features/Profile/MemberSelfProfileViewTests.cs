...
{
    /// <summary>
    /// Covers scenario: member self profile view shows non operational state for non member.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: member self profile view renders form and submits sanitized payload.
    /// </summary>
    [Fact]
