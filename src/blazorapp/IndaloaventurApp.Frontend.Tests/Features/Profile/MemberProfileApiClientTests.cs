namespace IndaloaventurApp.Frontend.Tests.Features.Profile;
...
{
    /// <summary>
    /// Covers scenario: get my member file gets member file from me endpoint.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: update my member file puts payload without membership fields.
    /// </summary>
    [Fact]
    ...
    /// <summary>
    /// Covers scenario: get my member file returns not member error for non member session.
    /// </summary>
    [Fact]
