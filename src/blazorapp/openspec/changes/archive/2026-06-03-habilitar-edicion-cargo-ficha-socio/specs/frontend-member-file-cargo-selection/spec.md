...
La ficha de socio MUST permitir modificar el cargo únicamente cuando el usuario autenticado tenga rol `Admin`, usando un selector alimentado con el catálogo de cargos disponible.
