# frontend-signal-comment-create-flow Specification

## Purpose
TBD - created by archiving change habilitar-comentarios-signal-autorizados. Update Purpose after archive.
## Requirements
