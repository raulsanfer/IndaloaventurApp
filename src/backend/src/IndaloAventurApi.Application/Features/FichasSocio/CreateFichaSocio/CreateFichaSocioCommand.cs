...
public sealed record CreateFichaSocioCommand(
...
public sealed class CreateFichaSocioCommandValidator : AbstractValidator<CreateFichaSocioCommand>
{
    public CreateFichaSocioCommandValidator()
    {
