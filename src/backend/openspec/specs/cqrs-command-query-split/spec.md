# cqrs-command-query-split Specification
...
The system MUST separate write operations (commands) from read operations (queries) through distinct handlers and contracts. Any user-facing validation or business message produced by command/query flows SHALL be in Spanish.
